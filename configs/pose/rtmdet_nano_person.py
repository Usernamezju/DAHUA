"""Official RTMDet-nano person detector configuration used by RTMPose.

This is the MMPose project configuration for the 320x320, one-class
RTMDet-nano detector.  Keeping it in the repository makes the TensorRT
export reproducible without relying on a network checkout at deployment
time.
"""
...
model = dict(
    ...
    test_cfg=dict(
        ...
        min_bbox_size=0,
        score_thr=0.05,
        # Match the nms_thr=0.5 used by the production MMPose inferencer.
        # The deployment postprocess is generated from this test_cfg.
