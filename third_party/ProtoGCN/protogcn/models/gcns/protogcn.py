...
class ProtoGCN(nn.Module):
    ...
    def __init__(self,
        ...
        # Keep the prototype reconstruction width aligned with the actual
        # final feature width.  This is 384 for the original Campus6 model and
        # also supports structurally pruned, narrower ProtoGCN variants.
        dim = out_channels
