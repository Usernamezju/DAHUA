"""Campus6 Halpe-26 -> COCO-17 -> Kinetics-2D ProtoGCN, full fine-tuning."""
...
work_dir = os.environ.get(
    ...
    "/workspace/data/xzz_data/DAHUA/experiments/ProtoGCN/campus6_rtmpose26_k400_2d_full",
)
...
# The split is grouped by source video.  We only repeat the rare
# conflict-chase class four times; CE remains unweighted to avoid double
# correcting the same class distribution.
...
model = dict(
    ...
    cls_head=dict(type="SimpleHead", joint_cfg=graph, num_classes=6, in_channels=384,
                  weight=.2, dropout=.20,
