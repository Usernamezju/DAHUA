"""Campus6: train only a new 6-class head on frozen NTU120 ProtoGCN features."""
...
work_dir = os.environ.get(
    ...
    "/workspace/data/xzz_data/DAHUA/experiments/ProtoGCN/campus6_mediapipe_ntu25_j_head_only",
)
...
# Validation is deliberately deferred to the final epoch: this small-data
# baseline is head-only, and per-epoch evaluation dominates its wall time.
