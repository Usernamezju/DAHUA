...
export DAHUA_CAMPUS6_DEPLOY_CONFIG="${DAHUA_CAMPUS6_DEPLOY_CONFIG:-${DAHUA_CODE_ROOT}/third_party/ProtoGCN/configs/campus6/rtmpose26_k400_2d_full.py}"
export DAHUA_CAMPUS6_DEPLOYMENT_CHECKPOINT="${DAHUA_CAMPUS6_DEPLOYMENT_CHECKPOINT:-${DAHUA_CODE_ROOT}/models/student/M1FKD.deployment.int8.pt}"
...
[[ -f "${DAHUA_CAMPUS6_DEPLOYMENT_CHECKPOINT}" ]] || { echo "M1FKD INT8 deployment checkpoint not found" >&2; exit 2; }
cd "${DAHUA_CODE_ROOT}"
